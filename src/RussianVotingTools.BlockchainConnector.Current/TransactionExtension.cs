...
namespace RussianVotingTools.BlockchainConnector
{
	...
	{
		public static ObjectModel.ITransactionWithId GetNestedTx(this Transaction transaction)
		{
		...
		public static byte[] GetContractId(this Transaction transaction)
		{
		...
		public static byte[] GetNestedTxId(this Transaction transaction)
		{
			var nested = transaction.GetNestedTx();
			if (nested != null)
			{
		...
		public static string GetOperationType(this Transaction tx)
		{
